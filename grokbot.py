...
@bot.tree.command(name="setreactuser", description="Set the user whose messages will be reacted with 🌈")
async def set_react_user(interaction: discord.Interaction, user: discord.User):
    ...
    user_pref_dirty = True  # Mark preferences as needing to be saved
